...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2024 at 04:25 PM
...
(23, 'Kategori Sampah', 'Route', 'AdminSampahCategoriesControllerGetIndex', NULL, 'fa fa-list', 0, 1, 0, 1, 1, '2023-04-09 11:08:04', NULL),
(24, 'Sampah', 'Route', 'AdminSampahControllerGetIndex', NULL, 'fa fa-trash-o', 0, 1, 0, 1, 2, '2023-04-09 11:09:36', NULL),
(26, 'Rewards', 'Route', 'AdminRewardsControllerGetIndex', NULL, 'fa fa-gift', 0, 1, 0, 1, 3, '2023-04-09 11:21:27', NULL),
(30, 'Nasabah', 'Route', 'AdminNasabahControllerGetIndex', 'normal', 'fa fa-users', 0, 1, 0, 1, 4, '2023-04-15 23:51:02', '2024-08-08 01:22:03'),
(31, 'Transaksi', 'Route', 'AdminTransactionsControllerGetIndex', 'normal', 'fa fa-exchange', 0, 1, 0, 1, 5, '2023-04-15 23:53:36', '2023-07-14 23:57:02'),
(32, 'Poin', 'Route', 'AdminPointsControllerGetIndex', NULL, 'fa fa-money', 0, 1, 0, 1, 6, '2023-05-08 00:47:26', NULL),
(33, 'Tukar Poin', 'Route', 'AdminTukarPoinsControllerGetIndex', NULL, 'fa fa-trophy', 0, 1, 0, 1, 7, '2023-05-08 00:59:42', NULL),
(35, 'Konten Edukasi', 'Route', 'AdminEducationControllerGetIndex', NULL, 'fa fa-file-o', 0, 1, 0, 1, 9, '2024-08-08 03:30:51', NULL),
(36, 'Saldo', 'Route', 'AdminSaldoControllerGetIndex', NULL, 'fa fa-money', 0, 1, 0, 1, 10, '2024-08-09 01:36:42', NULL),
(37, 'Tukar Saldo', 'Route', 'AdminTukarSaldoControllerGetIndex', NULL, 'fa fa-trademark', 0, 1, 0, 1, 11, '2024-08-09 07:22:06', NULL);
...
(2, 'Viral Warga Buang Sampah ke Kereta Barang, KAI: Terancam Denda Rp 15 Juta!', 'https://finance.detik.com/berita-ekonomi-bisnis/d-7468198/viral-warga-buang-sampah-ke-kereta-barang-kai-terancam-denda-rp-15-juta', 'uploads/1/2024-08/berita2.jpeg', '2024-08-08 14:13:23', '2024-08-08 07:13:23'),
...
(5, 20, 3100, '2024-08-06 01:41:42', '2024-08-09 02:30:28'),
(6, 21, 2200, '2024-08-07 05:33:15', '2024-08-10 02:35:08');
...
INSERT INTO `rewards` (`id`, `name`, `category`, `description`, `price`, `image`, `stock`, `created_at`, `updated_at`) VALUES
(5, 'Game', 'hiasan', 'Mainan anak', 1000, 'uploads/1/2024-08/pot_gemoy.png', 0, '2024-08-06 05:46:57', '2024-08-10 02:07:20'),
(6, 'Uang Cash', 'uang', 'Tukarkan uang ke petugas', 0, 'uploads/1/2024-08/berita1.jpeg', 93, '2024-08-09 03:21:42', '2024-08-10 02:29:35');
...
(1, 20, 3825, '2024-08-09 02:27:46', '2024-08-09 02:30:28'),
(2, 21, 15200, '2024-08-09 22:40:59', '2024-08-10 02:35:08');
...
INSERT INTO `sampah` (`id`, `category_id`, `name`, `image`, `price_per_kg`, `created_at`, `updated_at`) VALUES
(1, 1, 'Botol Plastik', 'uploads/1/2024-08/download.jpeg', 750, '2024-08-10 07:05:28', NULL),
(2, 1, 'Tutup Galon', 'uploads/1/2024-08/tutupgalon.jpeg', 500, '2024-08-10 07:05:47', NULL),
(3, 2, 'Kardus', 'uploads/1/2024-08/kardus.jpeg', 800, '2024-08-10 07:06:08', NULL),
(4, 2, 'Koran Bekas', 'uploads/1/2024-08/koran.jpeg', 750, '2024-08-10 07:06:25', NULL);
...
INSERT INTO `sampah_categories` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Plastik', 'sampah plastik', '2024-08-10 07:04:37', '2024-08-10 14:04:37'),
(2, 'Kertas', 'Sampah kertas', '2024-08-10 07:04:48', '2024-08-10 14:04:48');
...
(9, 20, 1, 5, 1, 1000, 'Diterima', '2024-08-07 23:27:51', '2024-08-08 01:29:51'),
(12, 21, NULL, 5, 1, 1000, 'Pending', '2024-08-10 02:07:20', '2024-08-10 02:07:20');
...
(4, 21, NULL, 6, 1, 5000, 'Pending', '2024-08-10 01:57:17', '2024-08-10 01:57:17'),
(5, 21, 1, 6, 1, 5000, 'Diterima', '2024-08-10 02:29:35', '2024-08-10 02:29:57');
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `address`, `phone_number`, `picture`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(20, 'arenga', 'arengapinnatamarzuki@gmail.com', '$2y$10$XQ1xaJR9SfN7h87jWrg76ex9Vp4qA.fSvlZAIHvoCpce1hwW5gFIy', 'Ciputat', '112233122', '/uploads/profile/1722946498_profile.png', NULL, NULL, '2024-08-06 01:41:42', '2024-08-06 05:14:58'),
(21, 'rizki', 'rizki@gmail.com', '$2y$10$wx5Prv7ldWVL2m4ozjuVV.97CSwxEDjvb6fjTYeiYxmjyib/WkTtW', NULL, NULL, NULL, NULL, NULL, '2024-08-07 05:33:15', '2024-08-07 05:33:15');
...
ALTER TABLE `tukar_saldo`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_user` (`user_id`,`admin_id`,`reward_id`),
...
--
ALTER TABLE `sampah`
  ADD CONSTRAINT `sampah_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `sampah_categories` (`id`);
